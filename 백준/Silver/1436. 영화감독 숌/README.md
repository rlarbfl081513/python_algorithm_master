...
이 문제는 완전탐색으로 풀어도 되는 전형적인 문제입니다. N이 최대 10,000입니다.666이 들어가는 10,000번째 숫자는 대략 2,600,000(260만) 정도입니다.컴퓨터는 1초에 약 1억 번의 연산을 하므로, 1부터 260만까지 전부 문자열로 바꿔서 검사해도 시간 제한(2초) 안에 넉넉하게 들어옵니다.
